...
mxEditor.prototype.addActions = function ()
{
	...
	this.addAction('toggleInspector', function(editor)
	{
		mxInspector.setVisible(!mxInspector.isVisible());
	});
	this.addAction('toggleCodeEditor', function(editor)
	{
		mxCodeEditor.setVisible(!mxCodeEditor.isVisible());
	});
};
...
*/ 
        ...
        if (cell.getObject()) {
          console.log(cell.getObject());
          customField = form.addTextarea('object', JSON.stringify(cell.getObject()), 8);
        }
