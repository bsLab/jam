...
mxClient.include(mxClient.basePath+'/js/util/utils.js');
mxClient.include(mxClient.basePath+'/js/util/mxCodeEditor.js');
mxClient.include(mxClient.basePath+'/js/util/mxInspector.js');
