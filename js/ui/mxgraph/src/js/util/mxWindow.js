...
// Move and resize window in wireframe mode? Observed choppy behaviour with full content visible.
var wireframe=true;
...
function mxWindow(title, content, x, y, width, height, minimizable, movable, replaceNode, style)
{
	if (content != null)
	{
        ...
        // Wireframe mode hack            
        if (wireframe) {
          this.addListener(mxEvent.MOVE_START, function(e)
           {
             //console.log('move_start');
             this.div.style.display = 'none';
             this.divframe.style.display = '';
           });            
          this.addListener(mxEvent.MOVE_END, function(e)
           {
             //console.log('move_end');
             this.div.style.display = '';
             this.divframe.style.display = 'none';
           });            
          this.addListener(mxEvent.RESIZE_START, function(e)
           {
             //console.log('move_start');
             this.div.style.visibility = 'hidden';
             this.divframe.style.display = '';
           });            
          this.addListener(mxEvent.RESIZE_END, function(e)
           {
             //console.log('move_end');
...
// Wireframe replacement
	if (wireframe) {
      this.divframe = document.createElement('div');
    	this.divframe.className = 'mxWindowFrame';
    }
	...
	if (width != null)
	{
        ...
        if (wireframe) this.divframe.style.width = width + 'px';   		
	...
	if (height != null)
	{
    	...
    	if (wireframe) this.divframe.style.height = height + 'px';		
		this.table.style.height = height + 'px';
	}
  	if (!this.divframe.style.height) this.divframe.style.height  = 50 + 'px';		
    
    
	if (wireframe){
      this.divframe.style.left = x + 'px';
  	  this.divframe.style.top = y + 'px';
      this.divframe.style.display = 'none';
    }
...
mxWindow.prototype.activate = function()
{
	if (mxWindow.activeWindow != this)
	{
		...
		if (wireframe) this.divframe.style.zIndex = parseInt(index) + 1;
...
mxWindow.prototype.setSize = function(width, height)
{
    ...
    if (wireframe) {
      this.divframe.style.width =  width + 'px';
      this.divframe.style.height = height + 'px';
	}
	...
	var funct = mxUtils.bind(this, function(evt)
	{
		...
		if (this.maximize.style.display != 'none')
		{
			if (!maximized)
			{
                ...
                if (wireframe) {
  		    	    this.divframe.style.width = (document.body.clientWidth - 2) + 'px';
	    	  		this.divframe.style.height = (docHeight - 2) + 'px';
                }
